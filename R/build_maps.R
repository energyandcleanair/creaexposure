...
build_maps <- function(res,
  ...
  diagnostics1 <- diagnose_obs_w_predictors(obs_w_predictors, suffix = suffix, folder = diagnostics_folder)
  diagnostics <- c(diagnostics, diagnostics1)
  ...
  diagnostics <- c(diagnostics, diagnostics2)
